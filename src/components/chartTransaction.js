...
function MychartTransactionExtend(){
    ...
    const handleGetDataChart=async()=>{
        ...
        const valuef = {
            ...
            StoreProcedureName: "SP_TRANSACTION_TRANSFER_CHART",
    ...
    const handleChart=()=>{
        const data = {
          ...
          const config = {
            ...
            options: {
              plugins: {
                title: {
                  display: true,
                  text: `¤ Tổng số lần Gia Hạn Tài sản vào hàng tháng ¤`,
                  color: '#6c757d',
                  font: {
                    size: 24,
                    weight: 'bold'
          ...
          $("div.chart-report1").append('<canvas id="myChart1"></canvas>')
        ...
        <div className='' >
            ...
            <div className=" bg-white">
              <div className="d-none d-md-block row p-3 ">
                <div className="col-md-12 chart-report1 ">
...
export default MychartTransactionExtend